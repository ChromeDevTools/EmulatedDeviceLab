...
var buildInTypes = [
  ...
  {
    title: "Google Nexus 7 (landscape)",
    width: 960,
    height: 600,
    deviceScaleFactor: 2,
    userAgent: "Mozilla/5.0 (Linux; Android 4.3; Nexus 7 Build/JSS15Q) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.72 Safari/537.36",
...
buildInTypes.forEach((type) => {
  //add build-in flag to easily distinguish between custom and build-in types
  type.buildIn = true;
